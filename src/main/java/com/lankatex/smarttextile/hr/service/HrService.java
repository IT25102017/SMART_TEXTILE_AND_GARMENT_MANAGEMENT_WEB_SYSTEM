...
public class HrService {
    ...
    public List<Employee> getAllEmployees() {
        return employeeRepository.findAll(Sort.by(Sort.Direction.DESC, "employeeId"));
    }
    ...
    public List<Shift> getAllShifts() {
        return shiftRepository.findAll(Sort.by(Sort.Direction.DESC, "shiftId"));
    }
    ...
    public AttendanceRecord saveAttendanceRecord(AttendanceRecord attendanceRecord) {
        ...
        if (attendanceRecord.getStatus() == null || attendanceRecord.getStatus().isBlank()) {
